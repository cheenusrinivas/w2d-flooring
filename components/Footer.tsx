    ...
    <footer className="bg-black border-t border-yellow-700/30 py-10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="flex gap-8 text-sm text-gray-400">
          ...
          <a href="https://www.instagram.com/w2d_flooring_carpets_" target="_blank" className="hover:text-yellow-500 transition-colors">Instagram</a>
        </div>

        <div className="text-xs text-gray-600 text-center">
          © 2026 W2D Flooring & Carpets. All rights reserved.<br />
          <span className="text-gray-500">@w2d_flooring_carpets_</span><br />
